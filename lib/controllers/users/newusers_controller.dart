...
class UsersController extends GetxController{
  ...
  List<HostUserModel> get filteredDevices {
    if (_filter == "BLOCKED") {
      return _devices.where((d) => d.type=="blocked").toList();
    }

    if (_filter == "FREE") {
      return _devices.where((d) => d.type=="bypassed").toList();
    }
    ...
    if (_filter == "NORMAL") {
      return _devices.where((d) => d.type=="regular").toList();
    }
  ...
  // Future<void> rename(HostUserModel d, String newName)async {
  //   isLoading=true;
  //   update();
  ...
  // Future<void> block(HostUserModel d)async {
  //   if (d.type.isBlocked) {
  ...
  // Future<void> unblock(HostUserModel d)async {
  //   if (!d.type.isBlocked) {
  ...
  // Future<void> makeFree(HostUserModel d)async {
  //   if (d.type.isFree) {
  ...
  // Future<void> delete(HostUserModel d)async {
  //   isLoading=true;
  //   update();
